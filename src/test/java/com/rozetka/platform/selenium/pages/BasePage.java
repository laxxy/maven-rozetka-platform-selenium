...
public class BasePage {
    ...
    protected String getBeforeAttribute(WebElement element, String value) {
        String script = String.format(
                "return window.getComputedStyle(arguments[0],':before').getPropertyValue('%s')", value);
    ...
    public void getPageScreenshot() {
        TestListener.attachScreenshot(new AShot().takeScreenshot(driver, driver.findElements(By.cssSelector("body"))));
    }
